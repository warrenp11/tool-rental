            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        ...
                        <button className="btn btn-outline-primary ms-auto px-4 rounded-pill">Shop</button>
                        <button className="btn btn-outline-primary ms-3 px-4 rounded-pill">Contact Us</button>
                    </div>
                </div>
            </div>
        </section>
